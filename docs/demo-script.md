...
| 10-20s | Click su "Ho diritto al biglietto accompagnatore" → appare il QR | "Con Zilath basta il wallet: la pagina chiede una credenziale, non un documento." |
...
| 75-90s | Ritorno alla pagina evento | "Verifichi una volta, compri ovunque come tutti. Il codice è open source: la fiducia si ispeziona. Questo è Zilath." |
