...
import dev.zilath.verifier.core.usableHttpsUriOrNull
...
/**
 * The shared shape rule, [usableHttpsUriOrNull] in `verifier-core`, which the status list
 * URI now obeys too.
 */
@OptIn(InternalZilathApi::class)
private fun usableFetchUrlOrNull(value: String): java.net.URI? = usableHttpsUriOrNull(value)
